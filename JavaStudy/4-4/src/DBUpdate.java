...
public class DBUpdate {
 ...
 private static final String JDBC_CONNECTION = "jdbc:postgresql://localhost:5432/JDBC_lesson";
 /** ・ユーザー名 */
  // 問② データベースのユーザー名を定数にしなさい
 private static final String USER = "postgres";
 /** ・パスワード */
  // 問③ データベースのパスワードを定数にしなさい。
 private static final String PASS = "Yota1220s";
 ...
 statement.executeUpdate(SQL);
  //一覧表示
 String SQLselect = "SELECT * FROM TB_SHOHIN ORDER BY shohin_id ASC";
